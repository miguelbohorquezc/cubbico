/**
 * @fileoverview Contenido del informe académico para secundaria
 * @module presentation/components/reports/SecondaryReportContent
 *
 * Componente que renderiza el informe académico para estudiantes de secundaria.
 * Agrupa las asignaturas por áreas académicas con headers visuales para cada grupo.
 */
...
import {
  ...
  type PrimaryReportContentProps
} from './PrimaryReportContent';

// Se importan los sub-componentes desde PrimaryReportContent
// ya que se reutilizan exactamente igual
...
export interface SecondaryReportContentProps {
  reportData: AreaGroup[];
...
const SubjectRow: React.FC<{ subject: any; index: number }> = ({ subject, index }) => {
...
export const SecondaryReportContent: React.FC<SecondaryReportContentProps> = ({
  reportData,
  studentInfo,
  periodId,
  director,
...
export default SecondaryReportContent;
